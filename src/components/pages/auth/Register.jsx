  ...
  return (
    <>
      ...
      <div
        ...
        className="flex justify-center items-center flex-col gap-10 mt-20  mb-32"
      >
        <div data-aos="fade-up" data-aos-duration="1500">
          <h1 className="text-center text-lg md:text-3xl lg:text-4xl font-extrabold md:font-bold bg-gradient-to-r from-[#e83e8c]  to-[#6610f2] bg-clip-text text-transparent uppercase">
            Begin Your Journey With CONFER
            <span className="block mt-2">Register Here</span>
          </h1>
        </div>
        <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none w-[300px] md:w-[420px] mx-5 md:mx-0">
          ...
          <form
            ...
            className="mt-6 mb-2 max-w-screen-lg"
          >
